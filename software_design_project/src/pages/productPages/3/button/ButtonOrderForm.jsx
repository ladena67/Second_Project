...
const addOns = [
{ key: "plasticPkg",  label: "Plastic Packaging",  sublabel: "Individual OPP bag per button",  icon: "🛍️", price: 2,  val: plasticPkg,  set: setPlasticPkg },
{ key: "backCard",    label: "Back Card Printing",  sublabel: "Custom card insert for branding", icon: "🃏", price: 3,  val: backCard,    set: setBackCard },
{ key: "waterproof",  label: "Waterproof Coating",  sublabel: "UV laminate for outdoor use",    icon: "💧", price: 2,  val: waterproof,  set: setWaterproof },
{ key: "glitter",     label: "Glitter Finish",      sublabel: "Sparkle effect on surface",      icon: "✨", price: 4,  val: glitter,     set: setGlitter },
]
...
<div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    {/* Button Details */}
    <SectionCard title="Button Details" icon="📌">
    ...
    <SectionCard title="Material & Finish" icon="🎨">
        ...
        <Field label="Backing Type">
            <div className="flex flex-col gap-2">
            {[
                { val: "Safety Pin",   icon: "📎", note: "" },
                { val: "Magnet",       icon: "🧲", note: "+₱5/pc" },
                { val: "Plastic Clip", icon: "🖇️", note: "" },
            ].map(({ val, icon, note }) => (
                <OptionCard
                key={val}
                active={backing === val}
