...
<div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    <SectionCard title="Mug Details" icon="☕">
    ...
    <SectionCard title="Design Customization" icon="🎨">
        ...
        <Field label="Upload Design File" hint="PNG, JPG, PDF accepted">
            ...
            {file
                ...
                : <p className="text-xs text-gray-400 text-center">Click to browse file</p>}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            ...
            <div className="flex flex-col gap-2">
                {[{ label: "↔ Landscape", value: "Landscape" },{ label: "↕ Portrait", value: "Portrait" }].map((o) => (
    ...
    <SectionCard title="Custom Text (Optional)" icon="✏️">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        ...
        {customText && (
            <div className="sm:col-span-3">
            <div className="bg-gray-50 border border-gray-100 rounded-xl p-4 flex items-center justify-center min-h-12">
    ...
    <SectionCard title="Additional Options" icon="📦">
        <div className="flex flex-col gap-5">
        <Field label="Box Packaging">
            <div className="flex gap-3">
            {[{ label: "🚫 No Box", val: false },{ label: "🎁 With Box (+₱20)", val: true }].map(({ label, val }) => (
