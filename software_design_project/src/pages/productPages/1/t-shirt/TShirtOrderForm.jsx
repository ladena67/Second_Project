...
<div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
    ...
    <SectionCard title="T-Shirt Details" icon="👕">
    ...
    <SectionCard title="Size Breakdown" icon="📏">
        ...
        <div className="mt-4 flex items-center gap-2 text-sm text-green-700 bg-green-50 rounded-xl px-4 py-2.5 border border-green-100">
            <span>✓</span><span>Size total: <strong>{sizeTotal} pcs</strong></span>
        </div>
        )}
    </SectionCard>
    ...
    <SectionCard title="Printing Method" icon="⚙️">
        <div className="flex flex-col gap-5">
        <Field label="Method">
